...
def ddim_step_with_logprob(
    ...
    prev_timestep = self.timesteps[timestep_idx+1] if timestep_idx+1<self.timesteps.shape[0] else torch.tensor(0, dtype=torch.int64, device=self.timesteps.device)
